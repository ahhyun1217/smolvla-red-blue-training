...
**SmolVLA**
- 양방향 분류 + 증강 — [so101_red_blue_cube_sorting](https://huggingface.co/datasets/AmberHyunKIM/so101_red_blue_cube_sorting) (80 ep) → [smolvla_red_blue_cube_sorting](https://huggingface.co/AmberHyunKIM/smolvla_red_blue_cube_sorting) · `configs/smolvla/red_blue.yaml`
